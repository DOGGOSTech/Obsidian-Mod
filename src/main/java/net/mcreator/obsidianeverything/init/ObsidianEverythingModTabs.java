...
@EventBusSubscriber
public class ObsidianEverythingModTabs {
	public static final DeferredRegister<CreativeModeTab> REGISTRY = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, ObsidianEverythingMod.MODID);
